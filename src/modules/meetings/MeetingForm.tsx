    ...
    return (
        ...
        <Col className='text-center border p-3 py-5' xs={12} md={8} lg={4}>
            <Form>
                ...
                <INput value={title} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>setTitle(e.target.value)} name='title' LabelName='Title' type='text' />
                <INput value={description} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>setDescription(e.target.value)} name='description' LabelName='Description' type='text' />
                <INput value={date} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>setDate(e.target.value)} name='date' LabelName='Date' type='date' />
                <INput value={status} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>setStatus(e.target.value)} name='status' LabelName='Status' type='text' />
